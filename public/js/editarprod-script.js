window.addEventListener('load', ()=>{
    ...
    let nombre = document.querySelector('#producto_nombre')
    let descripcion = document.querySelector('#producto_descripcion')
    let color = document.querySelector('#producto_color')
